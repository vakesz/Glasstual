...
.PHONY: help generate validate-generated-metadata build release archive run test tsan smoke coverage lint format format-check ensure-xcodegen ensure-formatters ensure-linters clean
