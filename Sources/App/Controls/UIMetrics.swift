...
/// The glyph column both side columns are built around. The member list and
/// the sidebar are two lists of the same shape beside the same conversation, so
/// a glyph column that differed between them would read as a mistake.
enum UIListMetrics {
