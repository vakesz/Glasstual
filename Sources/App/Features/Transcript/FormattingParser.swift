...
nonisolated enum FormattingParser {
	...
	private struct Parser {
		...
		private mutating func consume(_ character: UniChar, at position: Int) -> Int {
			...
			case TextFormatterControlCharacter.terminator:
