...
enum MenuFactory {
	...
	static func install(on controller: MenuActionController) {
		controller.serverListNoSelectionMenu = contextMenu([
			.item(String(localized: .MainWindow.menuServerAddServer), .serverListAddServer, #selector(MenuActionController.addServer(_:))),
		], controller)
...
private extension MenuFactory {
	...
	static let channelEntries: [Entry] = [
		...
		.item(String(localized: .MainWindow.menuChannelLeave), .leaveChannel, #selector(MenuActionController.leaveChannel(_:))),
		.separator(),
		.item(
			String(localized: .MainWindow.menuServerAddChannel),
			.addChannel,
	...
	static let queryEntries: [Entry] = [
		.item(String(localized: .MainWindow.menuQueryClose), .closeQuery, #selector(MenuActionController.leaveChannel(_:))),
		.separator(),
		.item(
	...
	static let transcriptEntries: [Entry] = [
		...
		.separator(),
		.item(String(localized: .MainWindow.menuEditCopy), .webCopy, #selector(NSText.copy(_:)), key: "c"),
		.item(String(localized: .MainWindow.menuEditPaste), .webPaste, #selector(MenuActionController.paste(_:)), key: "v"),
		.separator(),
		.item(
			String(localized: .MainWindow.menuQueryLogs),
			.webQueryLogs,
		...
		.item(String(localized: .MainWindow.menuBarChannel), .webChannelMenu),
	]
