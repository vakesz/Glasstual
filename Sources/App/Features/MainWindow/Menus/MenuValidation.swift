...
extension MenuActionController {
	...
	func validateMenuItem(_ menuItem: NSMenuItem) -> Bool {
		...
		return MenuValidation.isAvailable(
	...
	private func validateGeneralCommand(_ item: NSMenuItem) -> Bool {
		...
		case .queryLogs:
			return selectedChannel?.isPrivateMessage == true && Preferences.Logging.logToDiskIsEnabled
		case .developerMode:
	...
	private func validateChannelCommand(_ item: NSMenuItem) -> Bool {
		...
		case .viewChannelLogs:
			return channel != nil && Preferences.Logging.logToDiskIsEnabled
	...
	private func validateWindowCommand(_ item: NSMenuItem) -> Bool {
		...
		case .toggleServerList:
			item.title = MenuCommand.serverListTitle(isVisible: mainWindow.isServerListVisible)
			return mainWindow.isMainWindow
		case .toggleMemberList:
			item.title = MenuCommand.memberListTitle(isVisible: mainWindow.isMemberListVisible)
		...
		case .addressBook:
			return client != nil
		case .viewLogs:
			return Preferences.Logging.logToDiskIsEnabled
		case .highlightList:
	...
	private func validateWebCommand(_ item: NSMenuItem) -> Bool {
		...
		case .webPaste:
			return validatePaste()
		case .webQueryLogs:
			return channel?.isPrivateMessage == true && Preferences.Logging.logToDiskIsEnabled
		case .webChannelMenu:
			return channel?.isChannel == true
