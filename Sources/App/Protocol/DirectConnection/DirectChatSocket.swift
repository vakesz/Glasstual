...
nonisolated enum DCCChatEvent: Sendable {
...
private nonisolated let directChatConnectionLogger = Logger(
...
actor DirectChatSocket {
	...
	nonisolated let events: AsyncStream<DCCChatEvent>
...
nonisolated struct DCCChatLineFramer {
