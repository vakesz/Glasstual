...
/// `IRCClientNegotiation`.
public extension IRCClient {
	func isCapabilityEnabled(_ capability: ClientIRCv3SupportedCapability) -> Bool {
	...
	/// or `WATCH`.
	internal var supportsAdvancedTracking: Bool {
	...
	internal var monitorAwayStatus: Bool {
