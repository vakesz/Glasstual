...
public enum DirectChatConnectionState: UInt {
	case idle = 0
	case listening
	case connecting
	case connected
...
public final class DirectChatConnection: NSObject {
	...
	public private(set) var state: DirectChatConnectionState = .idle
	...
	private init(peer nickname: String, role: Role, onClient client: IRCClient) {
