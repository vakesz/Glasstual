...
final class PreferencesTransferSession {
	...
	private func closeConnections(of clients: [Client]) async throws {
	...
	private func resumeConnections(of clients: [Client]) {
	...
	private func checkStillApplicable(_ plan: PreferencesTransferPlan, changed: [Client]) throws {
		try checkApplicationIsRunning()
