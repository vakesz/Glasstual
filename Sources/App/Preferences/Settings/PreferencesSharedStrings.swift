...
enum PreferencesGeneralStrings {
	...
	static var preventSleepWhileConnected: String {
		String(localized: .Settings.preventSleepWhileConnected)
	}

	static var preventSleepExplanation: String {
		String(localized: .Settings.preventSleepExplanation)
	}
