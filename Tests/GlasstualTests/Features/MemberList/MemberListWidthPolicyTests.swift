...
struct MemberListWidthPolicyTests {
	...
	func widthsInRangeAreKept() {
		#expect(MemberListWidthPolicy.clamped(MemberListLayout.idealWidth)
	...
	func widthsOutsideRangeAreClamped() {
		#expect(MemberListWidthPolicy.clamped(0) == MemberListLayout.minimumWidth)
		#expect(MemberListWidthPolicy.clamped(10000) == MemberListLayout.maximumWidth)
		#expect(MemberListWidthPolicy.clamped(-40) == MemberListLayout.minimumWidth)
	}
