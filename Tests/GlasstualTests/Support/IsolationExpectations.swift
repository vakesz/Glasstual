...
nonisolated func isMainActor(_ isolation: (any Actor)?) -> Bool { // nonisolated: pure
...
nonisolated func describeIsolation(_ isolation: (any Actor)?) -> String { // nonisolated: pure
	guard let isolation else {
