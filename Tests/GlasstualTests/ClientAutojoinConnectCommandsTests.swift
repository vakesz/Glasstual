...
struct ClientAutojoinConnectCommandsTests {
	...
	private func makeClient(
		...
		delay: TimeInterval = ClientAutojoinConnectCommandsTests.settlingDelay
	) -> TestClient {
	...
	func delayAppliesOnlyWhereThereAreCommandsToWaitFor() {
		#expect(ClientAutojoinPolicy.delayAfterConnectCommands(
