...
struct OnboardingMigrationTests {
	...
	@Test("The onboarding window hosts SwiftUI and no longer loads a nib")
	func nativeWindowHostsSwiftUI() {
		let controller = OnboardingWindowController()

		#expect(controller.window?.contentViewController is NSHostingController<OnboardingView>)
