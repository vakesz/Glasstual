...
@MainActor
private final class RecordingChannelPresentation: ChatItemPresentation {
	...
	func print(_ logLine: LogLine, completionBlock _: PrintedLineCompletion?) {
...
struct ClientHighlightKeywordListTests {
	private func client(
